...
## 1.1.0 · 视觉 refresh（2026-09-17 立项，提案确认中）

- 背景：使用者反馈外观值得继续升级，「考虑得更加激进一点，而不是在原有的基础上做非常小的修改」。
- 性质：动结构与布局的大版本视觉refresh，不再是微调；提案见 `docs/design/v1.1-visual-refresh-proposal.md`，方向经使用者确认后按 rules §八.2 实施。
